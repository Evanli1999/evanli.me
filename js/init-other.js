...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: { //choose which CSS to invoke
			'global':	{ range: '*', href: 'css/style.css', containers: 1400, grid: { gutters: 40 }, viewport: { scalable: false } },
			'wide':		{ range: '961-4999', href: 'css/style-wide.css', containers: 1200, grid: { gutters: 40 } },
			...
			'mobile':	{ range: '-350', href: 'css/style-mobile-other.css', containers: '100%!', grid: { collapse: true } }
		},
		plugins: {
			layers: {
				config: {
